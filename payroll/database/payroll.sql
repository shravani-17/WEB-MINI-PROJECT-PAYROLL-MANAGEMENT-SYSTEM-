...
INSERT INTO `employee` (`emp_id`, `fname`, `lname`, `gender`, `emp_type`, `division`, `deduction`, `overtime`, `bonus`) VALUES
(6, 'Shravani', 'J', 'Female', 'Regular', 'MIS', 0, 2, 2),
(8, 'Ram', 'Pasadas', 'Male', 'Job Order', 'Human Resource', 5, 1, 1),
(9, 'Aishwarya', 'BR', 'Female', 'Casual', 'Admin', 1, 24, 10000),
(10, 'Jagadish', 'C', 'Male', 'Job Order', 'MIS', 1, 24, 10000),
(1, 'Manohar', 'D', 'Male', 'Regular', 'Admin', 1, 24, 10000),
(7, 'Deepak', 'J', 'Male', 'Casual', 'Human Resource', 1, 24, 10000);
